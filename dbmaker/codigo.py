...
while True:
    ...
    try:
        ...
        cursorlocal.execute('CREATE TABLE IF NOT EXISTS web_horariospermitidos (usuario integer, fecha_entrada date, fecha_salida date, entrada time without time zone, salida time without time zone, cedula_id varchar(150), dia varchar(180))')
