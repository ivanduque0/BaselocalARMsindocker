...
while True:
    ...
    try:
        ...
        cursorlocal.execute('CREATE TABLE IF NOT EXISTS web_logs_incidencias (vigilante_id integer, vigilante_nombre varchar(150), fecha date, hora time without time zone, contrato text, tipo_incidencia varchar(150), explicacion text, subido boolean)')
