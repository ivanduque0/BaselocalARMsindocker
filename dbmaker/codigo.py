...
while True:
    ...
    try:
        ...
        cursorlocal.execute('CREATE TABLE IF NOT EXISTS web_interacciones (nombre varchar(255), fecha date, hora time without time zone, razon varchar(150), contrato text, cedula_id varchar(150))')
        ...
        cursorlocal.execute('CREATE TABLE IF NOT EXISTS solicitud_aperturas (id integer, id_usuario varchar(150), acceso varchar(150), razon varchar(150), estado integer, peticionInternet boolean, feedback boolean, abriendo boolean)')
