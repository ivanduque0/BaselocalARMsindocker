...
comandos = [
    "python3 /BaselocalARMsindocker/dbmaker/codigo.py &",
    "python3 /BaselocalARMsindocker/dbmanagerall/codigo.py &",
    "python3 /BaselocalARMsindocker/dispositivosweb/codigo.py &",
    ...
    "python3 /BaselocalARMsindocker/servidorlocalwifi/codigo.py &",
    "python3 /BaselocalARMsindocker/aperturas/codigo.py &",
